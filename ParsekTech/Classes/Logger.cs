...
public static class Logger
{
    ...
    static Logger()
    {
        _logger = new LoggerConfiguration()
            ...
            .WriteTo.MSSqlServer(
                "Server=localhost\\SQLEXPRESS;Database=TelsizKodTakip; Integrated Security=True;TrustServerCertificate=True;Trusted_Connection=True;MultipleActiveResultSets=true",
